      ...
      <div class="container px-5 py-24 mx-auto">
        <div class=" md:text-left text-center -mb-10 -mx-4">
          <div className='text-center'>
            <h2 class="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">MARKET</h2>
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-600 hover:text-gray-800">BOSH SAHIFA</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">KATALOG</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">SAVATCHA</a>
              </li>
              <li>
                <a class="text-gray-600 hover:text-gray-800">ALOQA</a>
              </li>
            </nav>
          </div>
        </div>
